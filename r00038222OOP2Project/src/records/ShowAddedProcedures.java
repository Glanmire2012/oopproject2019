	...
	public void displayGrid() {
		try {
			...
			for (int i = 0; i < size; i++) {
				...
				Text procedureText = new Text(pro.getProcedureName());
				this.setConstraints(procedureText, 0, i);
				Text priceText = new Text("Cost €" + pro.getPrice() + "");
				this.setConstraints(priceText, 1, i);
